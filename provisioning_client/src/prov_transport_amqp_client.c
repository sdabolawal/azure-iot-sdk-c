...
#define PROV_AMQP_PORT_NUM               5671
...
static PROV_TRANSPORT_IO_INFO* amqp_transport_io(const char* fqdn, SASL_MECHANISM_HANDLE* sasl_mechanism, const HTTP_PROXY_OPTIONS* proxy_info)
{
    ...
    tls_io_config.port = PROV_AMQP_PORT_NUM;
    if (proxy_info != NULL)
    {
        /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_012: [ If proxy_info is not NULL, amqp_transport_io shall construct a HTTP_PROXY_IO_CONFIG object and assign it to TLSIO_CONFIG underlying_io_parameters ] */
        proxy_config.hostname = tls_io_config.hostname;
        proxy_config.port = PROV_AMQP_PORT_NUM;
    ...
    {
        /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_013: [ If any failure is encountered amqp_transport_io shall return NULL ] */
        LogError("platform_get_default_tlsio return NULL IO Interface");
        result = NULL;
    }
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_014: [ On success amqp_transport_io shall return an allocated PROV_TRANSPORT_IO_INFO structure. ] */
    else if ((result = (PROV_TRANSPORT_IO_INFO*)malloc(sizeof(PROV_TRANSPORT_IO_INFO))) == NULL)
    {
        /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_013: [ If any failure is encountered amqp_transport_io shall return NULL ] */
    ...
    else
    {
        ...
        /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_015: [ amqp_transport_io shall allocate a PROV_TRANSPORT_IO_INFO transfer_handle by calling xio_create with the tlsio_interface. ] */
        result->transport_handle = xio_create(tlsio_interface, &tls_io_config);
        ...
        else
        {
            ...
            if (sasl_mechanism != NULL)
            {
                ...
                {
                    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_016: [ amqp_transport_io shall allocate a PROV_TRANSPORT_IO_INFO sasl_handle by calling xio_create with the saslio_interface. ] */
...
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_002: [ prov_transport_amqp_destroy shall invoke the prov_transport_common_amqp_destroy method ] */
...
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_004: [ prov_transport_amqp_close shall invoke the prov_transport_common_amqp_close method ] */
    return prov_transport_common_amqp_close(handle);
}

int prov_transport_amqp_register_device(PROV_DEVICE_TRANSPORT_HANDLE handle, const char* registration_id, PROV_TRANSPORT_CHALLENGE_CALLBACK reg_challenge_cb, void* user_ctx, PROV_TRANSPORT_JSON_PARSE json_parse_cb, void* json_ctx)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_005: [ prov_transport_amqp_register_device shall invoke the prov_transport_common_amqp_register_device method ] */
...
int prov_transport_amqp_get_operation_status(PROV_DEVICE_TRANSPORT_HANDLE handle)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_006: [ prov_transport_amqp_get_operation_status shall invoke the prov_transport_common_amqp_get_operation_status method ] */
    return prov_transport_common_amqp_get_operation_status(handle);
}

void prov_transport_amqp_dowork(PROV_DEVICE_TRANSPORT_HANDLE handle)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_007: [ prov_transport_amqp_dowork shall invoke the prov_transport_common_amqp_dowork method ] */
    prov_transport_common_amqp_dowork(handle);
}

int prov_transport_amqp_set_trace(PROV_DEVICE_TRANSPORT_HANDLE handle, bool trace_on)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_008: [ prov_transport_amqp_set_trace shall invoke the prov_transport_common_amqp_set_trace method ] */
    return prov_transport_common_amqp_set_trace(handle, trace_on);
}

static int prov_transport_amqp_x509_cert(PROV_DEVICE_TRANSPORT_HANDLE handle, const char* certificate, const char* private_key)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_009: [ prov_transport_amqp_x509_cert shall invoke the prov_transport_common_amqp_x509_cert method ] */
    return prov_transport_common_amqp_x509_cert(handle, certificate, private_key);
}

static int prov_transport_amqp_set_trusted_cert(PROV_DEVICE_TRANSPORT_HANDLE handle, const char* certificate)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_010: [ prov_transport_amqp_set_trusted_cert shall invoke the prov_transport_common_amqp_set_trusted_cert method ] */
    return prov_transport_common_amqp_set_trusted_cert(handle, certificate);
}

static int prov_transport_amqp_set_proxy(PROV_DEVICE_TRANSPORT_HANDLE handle, const HTTP_PROXY_OPTIONS* proxy_options)
{
    /* Codes_PROV_TRANSPORT_AMQP_CLIENT_07_011: [ prov_transport_amqp_set_proxy shall invoke the prov_transport_common_amqp_set_proxy method ] */
