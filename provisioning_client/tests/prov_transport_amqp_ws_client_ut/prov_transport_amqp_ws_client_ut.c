...
BEGIN_TEST_SUITE(prov_transport_amqp_ws_client_ut)
    ...
    TEST_FUNCTION(prov_transport_amqp_register_device_succeed)
    {
        ...
        //act
        int result = prov_amqp_ws_transport_register_device(TEST_DPS_HANDLE, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
