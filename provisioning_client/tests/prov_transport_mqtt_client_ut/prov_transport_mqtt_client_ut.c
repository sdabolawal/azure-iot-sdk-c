...
static pfprov_transport_create prov_mqtt_transport_create;
static pfprov_transport_destroy prov_mqtt_transport_destroy;
static pfprov_transport_open prov_mqtt_transport_open;
static pfprov_transport_close prov_mqtt_transport_close;
static pfprov_transport_register_device prov_mqtt_transport_register_device;
static pfprov_transport_get_operation_status prov_mqtt_transport_get_op_status;
static pfprov_transport_dowork prov_mqtt_transport_dowork;
static pfprov_transport_set_trace prov_mqtt_transport_set_trace;
...
BEGIN_TEST_SUITE(prov_transport_mqtt_client_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        prov_mqtt_transport_create = Prov_Device_MQTT_Protocol()->prov_transport_create;
        prov_mqtt_transport_destroy = Prov_Device_MQTT_Protocol()->prov_transport_destroy;
        prov_mqtt_transport_open = Prov_Device_MQTT_Protocol()->prov_transport_open;
        prov_mqtt_transport_close = Prov_Device_MQTT_Protocol()->prov_transport_close;
        prov_mqtt_transport_register_device = Prov_Device_MQTT_Protocol()->prov_transport_register;
        prov_mqtt_transport_get_op_status = Prov_Device_MQTT_Protocol()->prov_transport_get_op_status;
        prov_mqtt_transport_dowork = Prov_Device_MQTT_Protocol()->prov_transport_dowork;
        prov_mqtt_transport_set_trace = Prov_Device_MQTT_Protocol()->prov_transport_set_trace;
    ...
    TEST_FUNCTION(prov_transport_mqtt_destroy_succeed)
    {
        ...
        //act
        prov_mqtt_transport_destroy(TEST_DPS_HANDLE);
    ...
    TEST_FUNCTION(prov_transport_mqtt_close_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_close(TEST_DPS_HANDLE);
    ...
    TEST_FUNCTION(prov_transport_mqtt_register_device_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_register_device(TEST_DPS_HANDLE, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(prov_transport_mqtt_get_operation_status_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_get_op_status(TEST_DPS_HANDLE);
    ...
    TEST_FUNCTION(prov_transport_mqtt_dowork_succeed)
    {
        ...
        //act
        prov_mqtt_transport_dowork(TEST_DPS_HANDLE);
    ...
    TEST_FUNCTION(prov_transport_mqtt_set_trace_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_set_trace(TEST_DPS_HANDLE, true);
    ...
    TEST_FUNCTION(prov_transport_mqtt_x509_cert_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_x509_cert(TEST_DPS_HANDLE, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    TEST_FUNCTION(prov_transport_mqtt_set_trusted_cert_succeed)
    {
        ...
        //act
        int result = prov_mqtt_transport_trusted_cert(TEST_DPS_HANDLE, TEST_CERT_VALUE);
    ...
    END_TEST_SUITE(prov_transport_mqtt_client_ut)
