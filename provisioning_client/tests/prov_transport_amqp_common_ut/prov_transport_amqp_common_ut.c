...
BEGIN_TEST_SUITE(prov_transport_amqp_common_ut)
    ...
    TEST_FUNCTION(prov_transport_common_amqp_register_device_handle_NULL_succeed)
    {
        ...
        //act
        int result = prov_transport_common_amqp_register_device(NULL, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_PROV_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, prov_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(prov_transport_common_amqp_register_device_registration_id_NULL_fail)
    {
        PROV_DEVICE_TRANSPORT_HANDLE handle = prov_transport_common_amqp_create(TEST_URI_VALUE, TRANSPORT_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = prov_transport_common_amqp_register_device(handle, NULL, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(prov_transport_common_amqp_register_device_challenge_NULL_succeed)
    {
        ...
        //act
        int result = prov_transport_common_amqp_register_device(handle, TEST_REGISTRATION_ID_VALUE, NULL, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(prov_transport_common_amqp_register_device_succeed)
    {
        ...
        //act
        int result = prov_transport_common_amqp_register_device(handle, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    {
        PROV_DEVICE_TRANSPORT_HANDLE handle = prov_transport_common_amqp_create(TEST_URI_VALUE, TRANSPORT_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)prov_transport_common_amqp_register_device(handle, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        umock_c_reset_all_calls();
