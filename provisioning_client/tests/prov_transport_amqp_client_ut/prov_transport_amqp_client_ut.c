...
static pfprov_transport_create prov_amqp_transport_create;
static pfprov_transport_destroy prov_amqp_transport_destroy;
static pfprov_transport_open prov_amqp_transport_open;
static pfprov_transport_close prov_amqp_transport_close;
static pfprov_transport_register_device prov_amqp_transport_register_device;
static pfprov_transport_get_operation_status prov_amqp_transport_get_op_status;
static pfprov_transport_dowork prov_amqp_transport_dowork;
static pfprov_transport_set_trace prov_amqp_transport_set_trace;
static pfprov_transport_set_x509_cert prov_amqp_transport_x509_cert;
static pfprov_transport_set_trusted_cert prov_amqp_transport_trusted_cert;
static pfprov_transport_set_proxy prov_amqp_transport_set_proxy;
...
BEGIN_TEST_SUITE(prov_transport_amqp_client_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        prov_amqp_transport_create = Prov_Device_AMQP_Protocol()->prov_transport_create;
        prov_amqp_transport_destroy = Prov_Device_AMQP_Protocol()->prov_transport_destroy;
        prov_amqp_transport_open = Prov_Device_AMQP_Protocol()->prov_transport_open;
        prov_amqp_transport_close = Prov_Device_AMQP_Protocol()->prov_transport_close;
        prov_amqp_transport_register_device = Prov_Device_AMQP_Protocol()->prov_transport_register;
        prov_amqp_transport_get_op_status = Prov_Device_AMQP_Protocol()->prov_transport_get_op_status;
        prov_amqp_transport_dowork = Prov_Device_AMQP_Protocol()->prov_transport_dowork;
        prov_amqp_transport_set_trace = Prov_Device_AMQP_Protocol()->prov_transport_set_trace;
        prov_amqp_transport_x509_cert = Prov_Device_AMQP_Protocol()->prov_transport_x509_cert;
        prov_amqp_transport_trusted_cert = Prov_Device_AMQP_Protocol()->prov_transport_trusted_cert;
        prov_amqp_transport_set_proxy = Prov_Device_AMQP_Protocol()->prov_transport_set_proxy;
    }
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_001: [ prov_transport_amqp_create shall call the prov_transport_common_amqp_create function with amqp_transport_io transport IO estabishment. ] */
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_014: [ On success amqp_transport_io shall return an allocated DPS_TRANSPORT_IO_INFO structure. ] */
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_015: [ amqp_transport_io shall allocate a transfer_handle by calling xio_create with the tlsio_interface. ] */
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_016: [ amqp_transport_io shall allocate a DPS_TRANSPORT_IO_INFO sasl_handle by calling xio_create with the saslio_interface. ] */
    TEST_FUNCTION(prov_amqp_transport_io_succeed)
    {
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_017: [ If sasl_mechanism is NULL amqp_transport_io shall assign the transfer_handle to the result and return the value. ] */
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_013: [ If any failure is encountered amqp_transport_io shall return NULL ] */
    TEST_FUNCTION(prov_amqp_transport_io_fail)
    {
        SASL_MECHANISM_HANDLE sasl_mechanism = { 0 };
        PROV_TRANSPORT_IO_INFO* dps_io_info;
        (void)prov_amqp_transport_create(TEST_URI_VALUE, TRANSPORT_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_DPS_API_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_012: [ If proxy_info is not NULL, amqp_transport_io shall construct a HTTP_PROXY_IO_CONFIG object and assign it to TLSIO_CONFIG underlying_io_parameters ] */
    TEST_FUNCTION(prov_amqp_transport_io_w_http_proxy_succeed)
    {
        SASL_MECHANISM_HANDLE sasl_mechanism = { 0 };
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_002: [ prov_transport_amqp_destroy shall invoke the prov_transport_common_amqp_destroy method ] */
    TEST_FUNCTION(prov_transport_amqp_destroy_succeed)
    {
        ...
        //act
        prov_amqp_transport_destroy(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_003: [ prov_transport_amqp_open shall invoke the prov_transport_common_amqp_open method ] */
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_004: [ prov_transport_amqp_close shall invoke the prov_transport_common_amqp_close method ] */
    TEST_FUNCTION(prov_transport_amqp_close_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_close(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_005: [ prov_transport_amqp_register_device shall invoke the prov_transport_common_amqp_register_device method ] */
    TEST_FUNCTION(prov_transport_amqp_register_device_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(prov_transport_common_amqp_register_device(TEST_DPS_HANDLE, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL));

        //act
        int result = prov_amqp_transport_register_device(TEST_DPS_HANDLE, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_006: [ prov_transport_amqp_get_operation_status shall invoke the prov_transport_common_amqp_get_operation_status method ] */
    TEST_FUNCTION(prov_transport_amqp_get_operation_status_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_get_op_status(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_007: [ prov_transport_amqp_dowork shall invoke the prov_transport_common_amqp_dowork method ] */
    TEST_FUNCTION(prov_transport_amqp_dowork_succeed)
    {
        ...
        //act
        prov_amqp_transport_dowork(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_008: [ prov_transport_amqp_set_trace shall invoke the prov_transport_common_amqp_set_trace method ] */
    TEST_FUNCTION(prov_transport_amqp_set_trace_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_set_trace(TEST_DPS_HANDLE, true);
    ...
    TEST_FUNCTION(prov_transport_amqp_x509_cert_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_x509_cert(TEST_DPS_HANDLE, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_010: [ prov_transport_amqp_set_trusted_cert shall invoke the prov_transport_common_amqp_set_trusted_cert method ] */
    TEST_FUNCTION(prov_transport_amqp_set_trusted_cert_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_trusted_cert(TEST_DPS_HANDLE, TEST_CERT_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_CLIENT_07_011: [ prov_transport_amqp_set_proxy shall invoke the prov_transport_common_amqp_set_proxy method ] */
    TEST_FUNCTION(prov_transport_amqp_set_proxy_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_set_proxy(TEST_DPS_HANDLE, &proxy_options);
    ...
    END_TEST_SUITE(prov_transport_amqp_client_ut)
