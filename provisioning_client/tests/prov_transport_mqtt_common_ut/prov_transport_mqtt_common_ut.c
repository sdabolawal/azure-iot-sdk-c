...
BEGIN_TEST_SUITE(prov_transport_mqtt_common_ut)
    ...
    {
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(mqttmessage_create(IGNORED_NUM_ARG, IGNORED_PTR_ARG, DELIVER_AT_MOST_ONCE, NULL, 0));
    ...
    /* Tests_PROV_TRANSPORT_MQTT_COMMON_07_002: [ If any error is encountered, prov_transport_common_mqtt_create shall return NULL. ] */
    ...
    /* Codes_PROV_TRANSPORT_MQTT_COMMON_07_003: [ prov_transport_common_mqtt_create shall allocate a DPS_TRANSPORT_MQTT_INFO and initialize the containing fields. ] */
    ...
    TEST_FUNCTION(prov_transport_common_mqtt_register_device_handle_NULL_succeed)
    {
        ...
        //act
        int result = prov_transport_common_mqtt_register_device(NULL, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_PROV_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, prov_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(prov_transport_common_mqtt_register_device_registration_id_NULL_fail)
    {
        PROV_DEVICE_TRANSPORT_HANDLE handle = prov_transport_common_mqtt_create(TEST_URI_VALUE, TRANSPORT_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = prov_transport_common_mqtt_register_device(handle, NULL, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(prov_transport_common_mqtt_register_device_challenge_NULL_succeed)
    {
        ...
        //act
        int result = prov_transport_common_mqtt_register_device(handle, TEST_REGISTRATION_ID_VALUE, NULL, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(prov_transport_common_mqtt_register_device_succeed)
    {
        ...
        //act
        int result = prov_transport_common_mqtt_register_device(handle, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    {
        PROV_DEVICE_TRANSPORT_HANDLE handle = prov_transport_common_mqtt_create(TEST_URI_VALUE, TRANSPORT_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)prov_transport_common_mqtt_register_device(handle, TEST_REGISTRATION_ID_VALUE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        umock_c_reset_all_calls();
    ...
    /* Tests_PROV_TRANSPORT_MQTT_COMMON_07_055: [ When then transport_state is set to TRANSPORT_CLIENT_STATE_STATUS_SEND, prov_transport_common_mqtt_dowork shall send a AMQP_OPERATION_STATUS message ] */
    /* Tests_PROV_TRANSPORT_MQTT_COMMON_07_056: [ Upon successful sending of a AMQP_OPERATION_STATUS message, prov_transport_common_mqtt_dowork shall set the transport_state to TRANSPORT_CLIENT_STATE_STATUS_SENT ] */
